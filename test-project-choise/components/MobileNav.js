...
export default function MobileNav() {
	...
	return (
		<Wrapper className={snap.mobNav ? "active": ""}>
			<CenterBlock>
				<ul>
					<li><Link href="/about">{t.about}</Link></li>
					<li><a href="#" target="_blank" rel="noreferrer">{t.documentation}</a></li>
					<li><a href="#" target="_blank" rel="noreferrer">{t.open_link}</a></li>
					<div className="circles">
						<li><a href="#" target="_blank" rel="noreferrer" className="circle_icon markets">
						...
						<li><a href="#" target="_blank" rel="noreferrer" className="circle_icon border">
					...
					<div className="languages">
						{
							array.map((item, index) => {
								return(
									<li key={index}>
										<Link
											className={locale === item ? "circle_icon active_language" : "circle_icon border"}
											href={asPath}
											locale={item}
										>{item}</Link>
									</li>
